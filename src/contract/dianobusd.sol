...
contract DianoBusd is Context, Ownable {
    using SafeMath for uint256;
    uint256 public constant min = 0.05 ether;
    uint256 public constant max = 500 ether;
    uint256 public roi = 8;
    uint256 public constant fee = 10;
    uint256 public constant withdraw_fee = 2;
    uint256 public constant ref_fee = 10;
    address public dev = 0xfD73bb99aaC01436cD4295C82afD88519f8624E3;
    IERC20 private BusdInterface;
    address public tokenAdress;


    constructor() {
    tokenAdress = 0x9388E2A62557E8814E68e00786064f149bA22B67; 
